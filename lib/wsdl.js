...
class AllElement extends Element
{
  constructor(nsName, attrs, options) {
    ...
    this.allowedChildren = 'element choice'.split(' ');
  }
...
class AnyElement extends Element
{
  constructor(nsName, attrs, options) {
    ...
    this.allowedChildren = []; // any: [AnyElement, ''],
  }
}
...
class BindingElement extends Element
{
  constructor(nsName, attrs, options) {
    ...
    this.style = '';
    this.methods = {};
    this.allowedChildren = '_binding SecuritySpec operation documentation'.split(' ');
  }
...
class ChoiceElement extends Element
{
  constructor(nsName, attrs, options) {
    super(nsName, attrs, options);
    this.allowedChildren = 'element sequence choice any'.split(' ');
  }
...
class ComplexContentElement extends Element
{
  constructor(nsName, attrs, options) {
    super(nsName, attrs, options);
    this.allowedChildren = 'extension'.split(' ');
  }
...
class ComplexTypeElement extends Element
{
  constructor(nsName, attrs, options) {
    super(nsName, attrs, options);
    this.allowedChildren = 'annotation sequence all complexContent simpleContent choice'.split(' ');
  }
...
class DefinitionsElement extends Element
{
  constructor(nsName, attrs, options) {
    ...
    this.services = {};
    this.schemas = {};
    this.allowedChildren = 'types message portType binding service import documentation'.split(' ');
  }
...
class ElementElement extends Element
{
  constructor(nsName, attrs, options) {
    super(nsName, attrs, options);
    this.allowedChildren = 'annotation complexType'.split(' ');
  }
...
class ExtensionElement extends Element
{
  constructor(nsName, attrs, options) {
    super(nsName, attrs, options);
    this.allowedChildren = 'all sequence choice'.split(' ');
  }
...
class InputElement extends Element
{
  constructor(nsName, attrs, options) {
    super(nsName, attrs, options);
    this.allowedChildren = 'body SecuritySpecRef documentation header'.split(' ');
  }
...
class MessageElement extends Element
{
  constructor(nsName, attrs, options) {
    ...
    this.element = null;
    this.parts = null;
    this.allowedChildren = 'part documentation'.split(' ');
  }
...
class OperationElement extends Element
{
  constructor(nsName, attrs, options) {
    ...
    this.style = '';
    this.soapAction = '';
    this.allowedChildren = 'documentation input output fault _operation'.split(' ');
  }
...
class PortElement extends Element
{
  constructor(nsName, attrs, options) {
    super(nsName, attrs, options);
    this.location = null;
    this.allowedChildren = 'address documentation'.split(' ');
  }
}
...
class PortTypeElement extends Element
{
  constructor(nsName, attrs, options) {
    super(nsName, attrs, options);
    this.methods = {};
    this.allowedChildren = 'operation documentation'.split(' ');
  }
...
class RestrictionElement extends Element
{
  constructor(nsName, attrs, options) {
    super(nsName, attrs, options);
    this.allowedChildren = 'enumeration all choice sequence'.split(' ');
  }
...
class SchemaElement extends Element
{
  constructor(nsName, attrs, options) {
    ...
    this.elements = {};
    this.includes = [];
    this.allowedChildren = 'element complexType simpleType include import'.split(' ');
  }
...
class ServiceElement extends Element
{
  constructor(nsName, attrs, options) {
    super(nsName, attrs, options);
    this.ports = {};
    this.allowedChildren = 'port documentation'.split(' ');
  }
...
class SimpleTypeElement extends Element
{
  constructor(nsName, attrs, options) {
    super(nsName, attrs, options);
    this.allowedChildren = 'restriction'.split(' ');
  }
...
class TypesElement extends Element
{
  constructor(nsName, attrs, options) {
    super(nsName, attrs, options);
    this.schemas = {};
    this.allowedChildren = 'schema documentation'.split(' ');
  }
